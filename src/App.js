  ...
  renderVictory() {
    if (this.state.player1Tokens.indexOf(false) === -1) {
      return (<div className="winner" >
        <p className="pWins"> <span
          className="spanP1">Player 1</span> Wins !</p>
      ...
      return (<div className="winner" >
        ...
        <div className="offset-3"
          style={{ background: `url(${Winner})`, height: `${500}px`, backgroundRepeat: "no-repeat" }} />
      </div>)
              ...
              <div className="grid-game">
                ...
                <div className="flex grid-item-5">
                  ...
                  <div className="numeroDee">
                    ...
                    <p className="rainbow">Petits Chevaux</p>
                    <button className={this.state.currentPlayer === 1 ? "b1" : "b2"}
                      onClick={this.lancerDee}>Lancer du joueur {this.state.currentPlayer}</button>
                  </div>
                </div>
